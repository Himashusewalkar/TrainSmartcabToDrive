...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=0.15, alpha=0.7):
    ...
    def createQ(self, state):
        ...
        if self.learning == True:
            if not state in self.Q:
                state_dict = {None :0.0,'forward' : 0.0, 'left' : 0.0, 'right' : 0.0}
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if self.epsilon >= random_num:
                ...
                best_actions = []  # Initialize a list
                for key in self.Q[state].keys():
                    if self.Q[state][key] == max_v:
